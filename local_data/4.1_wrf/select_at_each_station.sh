...
# 
#       OPTIONS: ---
#  REQUIREMENTS: --- netcdf2csv.2.py
#  REQUIREMENTS: --- station_meteofrance
#          BUGS: --- unknown
#         NOTES: ---
...
DIR=/Users/ctang/Microsoft_OneDrive/OneDrive/CODE/Morel_2020/local_data/4.1_wrf

# ----------------------------- data -----------------------------
grid_nc=$DIR/SWDOWNC.hour.d03.wrf4.1.nc
var=SWDOWNC
reso=0.0073
# --------------------- station meteofrance ----------------------
station_file=$DIR/station_meteofrance.2004-2005.with_rg.csv

output=$DIR/wrf41.20041015-20050430.station_meteoFrance.clearsky.csv
...
do
    ...
    longitude=$(awk -F "," 'NR=='$line'{print $2}' $station_file)
    ...
    ./netcdf2csv.2.py $grid_nc $var -time Times -lon $longitude -lat $latitude -prefix $station_id, > $station_id.csv.temp
